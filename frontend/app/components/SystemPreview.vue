        ...
        >
            ...
            >
                ...
                <span class="hidden items-center gap-2 sm:flex"
                    ><i class="size-1.5 rounded-full bg-emerald-500" />Todos los
                    servicios operativos</span
                >
                <span>v2.1</span>
            </div>
            ...
            <div class="grid min-h-[38rem] md:grid-cols-[13rem_1fr]">
                <aside
                    class="hidden border-r border-line bg-background p-2 md:block"
                >
                ...
                >
                    ...
                    >
                        <div class="max-w-3xl">
                            <p
                                class="mb-4 flex items-center gap-2 text-xs text-signal"
                            >
                                <Network :size="16" />Dentro del sistema
                            </p>
                            <h2
                                id="system-preview-title"
                                class="m-0 max-w-[16ch] font-display text-[clamp(4.5rem,8vw,8rem)] leading-[0.72] tracking-[-0.03em]"
                            >
                                El portfolio también es un producto.
                            </h2>
                        </div>
                        <p class="m-0 max-w-sm text-sm leading-6 text-muted">
                            Una vista pública de la aplicación, las APIs, los
                            datos y la infraestructura que mantiene esta web en
                            producción.
                        </p>
                    </div>
...
const nav = [
    { label: "Vista general", path: "/system#overview", icon: Activity },
    { label: "Frontend", path: "/system#frontend", icon: Braces },
    { label: "API pública", path: "/system#public-api", icon: Server },
    { label: "Base de datos", path: "/system#database", icon: Database },
    { label: "Docker", path: "/system#docker", icon: Container },
    { label: "Seguridad", path: "/system#security", icon: ShieldCheck },
    { label: "GitHub", path: "/github", icon: GitFork },
];
