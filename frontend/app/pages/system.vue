<template>
  <div id="top" class="min-h-screen bg-background pt-14">
    ...
    >
      ...
      >
        <div class="flex min-w-0 items-center gap-2 text-xs text-muted">
          ...
          <span class="truncate text-ink">Documentación del sistema</span>
        </div>
    ...
    >
      ...
      >
        <div class="mb-3 rounded-sm border border-line bg-surface p-2.5">
          ...
          <div class="mt-3 grid grid-cols-2 gap-1 text-[10px] text-muted">
            <span>Producción</span>
            <span class="text-right">v2.1.0</span>
          </div>
        </div>

        <div v-for="group in navigation" :key="group.label" class="mb-4">
          <p
          ...
          >
            <a
              ...
              :class="
                activeSection === item.id ? '!bg-surface-raised !text-ink' : ''
              "
            >
              <component :is="item.icon" :size="16" />
              {{ item.label }}
        ...
        >
          ...
          Se actualiza junto al producto y describe el repositorio real.
        </div>
      </aside>
        ...
        <div class="mx-auto max-w-5xl">
          ...
          >
            <div class="flex flex-wrap items-center gap-2 text-xs text-muted">
              <span
                ...
                ><Radio :size="16" class="text-emerald-400" />Producción
                operativa</span
              >
              <span class="rounded-sm border border-line px-2 py-1"
            ...
            <h1
              class="mt-7 mb-0 max-w-[11ch] font-display text-[clamp(4.6rem,9vw,9rem)] leading-[0.72] tracking-[-0.03em]"
            >
              Un producto que puedes abrir por dentro.
            </h1>
            <p class="mt-7 max-w-2xl text-base leading-7 text-muted">
              Este portfolio es la interfaz pública de un pequeño sistema
              distribuido. Nuxt renderiza la experiencia, Rust expone los datos,
              Python ejecuta procesos internos y PostgreSQL mantiene las
              relaciones.
            </p>
            ...
            <div class="mt-10 grid gap-2 sm:grid-cols-3">
              ...
              >
                <div class="flex items-center justify-between text-muted">
                  <component :is="metric.icon" :size="16" /><span
                    class="text-[10px]"
                    >{{ metric.change }}</span
                  >
                </div>
            ...
            >
              ...
              >
                <span class="flex items-center gap-2"
                  ><Workflow :size="16" />Mapa de arquitectura</span
                ><span>Petición pública</span>
              </div>
              <div class="grid gap-px bg-line p-px md:grid-cols-4">
                <div
          ...
          >
            ...
            >
              ...
              >
                ...
                ><span class="hidden sm:block">Descripción</span>
              </div>
              <div
            ...
            <Callout title="Dos identidades de base de datos"
              >La API abre pools separados para lectura y escritura. Las
              consultas públicas quedan aisladas del envío de contacto.</Callout
            >
          </article>
          ...
          >
            <DocHeading
              ...
              description="FastAPI no publica contenido al navegador. Ejecuta tareas programadas y mantiene los datos externos normalizados."
            />
            <ol class="mt-9 grid gap-2 sm:grid-cols-2">
              ...
              >
                <span
                  ...
                  >{{ index + 1 }}</span
                >
                <p class="m-0 pt-1 text-xs leading-5 text-muted">{{ step }}</p>
              </li>
            </ol>
          </article>
          ...
          >
            ...
            <div class="mt-9 grid gap-2 sm:grid-cols-3">
              ...
              <DocCard
                number="I"
                title="integrations"
                text="Metadatos, lenguajes y colaboradores procedentes de servicios externos."
              />
              <DocCard
                number="C"
                title="contact"
          ...
          >
              ...
              >
                <div class="mb-8 flex items-center justify-between">
                  ...
                  /><span class="flex items-center gap-2 text-xs text-muted"
                    ><i class="size-1.5 rounded-full bg-emerald-500" />Puerto
                    {{ service.port }}</span
                  >
                </div>
                <strong class="block text-sm font-medium">{{
            ...
            <CodeBlock filename="docker-compose.yml" :lines="dockerCode" />
          </article>
          ...
          >
            ...
            >
              ...
              >
                ...
                <p class="m-0 pt-1 text-xs leading-5 text-muted">
                  {{ flow.text }}
                </p>
              </div>
            </div>
          ...
          >
            ...
            <Callout title="Protección de contacto"
              >Las peticiones generales tienen un límite de 120 por minuto y la
              ruta de contacto uno independiente de 3 por minuto.</Callout
            >
          </article>
          ...
          <article
            id="decisions"
            data-doc-section
            class="scroll-mt-32 border-t border-line pt-16"
            data-reveal
          >
            <DocHeading
              eyebrow="Apéndice"
...
const workerSteps = [
  ...
  "Las integraciones externas se consultan fuera de la petición del usuario.",
...
const services = [
  ...
  { icon: Server, name: "rust-api", image: "rust:1.96 · Axum", port: "8000" },
  {
    icon: Cpu,
    name: "python-api",
...
const requestFlow = [
  {
    ...
    text: "El composable consulta proyectos, repositorios y clientes en paralelo.",
  },
  {
...
const frontendCode = [
  "const [projects, repositories, clients] = await Promise.all([",
...
useSeoMeta({
  ...
  description:
    "Documentación viva del frontend, las APIs, los datos y la arquitectura Docker de impablo.dev.",
  ogType: "article",
});
</script>
