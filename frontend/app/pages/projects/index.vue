    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Todos <span class="ml-1 opacity-55">{{ projects.length }}</span>
          </button>
          <button
          ...
          >
            {{ type }}
            <span class="ml-1 opacity-55">{{ countByType(type) }}</span>
          </button>
        </div>
      </div>
      ...
      >
        <div>
          ...
          <p class="mx-auto mt-4 mb-0 max-w-md text-sm leading-6 text-muted">
            {{
              error
