  ...
  <div class="bg-background">
    ...
    >
      <span class="flex items-center gap-2"
        ><LoaderCircle :size="16" class="animate-spin" />Cargando caso de
        estudio</span
      >
    </div>
        ...
        <div class="mx-auto max-w-[92rem]">
          ...
          >
            ...
            >
              <span class="flex items-center gap-2"
                ><Box :size="16" />Caso
                {{ project.id.toString().padStart(3, "0") }}</span
              >
              <span class="hidden sm:block"
                >{{ yearOf(project) }} / {{ project.project_type }}</span
              >
              <span class="flex items-center gap-2"
            ...
            >
              ...
              <div class="relative z-10 flex flex-col justify-between">
                <p class="m-0 flex items-center gap-2 text-xs text-signal">
                ...
                <div class="my-14 lg:my-10">
                  ...
                  <p class="mt-7 max-w-xl text-sm leading-6 text-muted">
      ...
      <section class="px-3 py-20 sm:px-6 sm:py-28">
        ...
        >
          <aside
            ...
            data-reveal
          >
            <div class="border-b border-line px-2 py-2 text-xs text-muted">
              Metadatos del proyecto
            </div>
            <dl class="m-0">
              <div class="border-b border-line px-2 py-3">
                <dt class="mb-2 flex items-center gap-2 text-xs text-muted">
              ...
              <div v-if="project.client" class="border-b border-line px-2 py-3">
                <dt class="mb-2 flex items-center gap-2 text-xs text-muted">
                ...
                <dd class="m-0 text-xs font-medium">
                  <a
                    ...
                    >{{ project.client.name }}<ArrowUpRight :size="16"
                  /></a>
                  <template v-else>{{ project.client.name }}</template>
                </dd>
              </div>
              <div
          ...
          <div data-reveal>
            <p class="mb-5 flex items-center gap-2 text-xs text-signal">
            ...
            >
              ...
              >
                ...
                <div class="mt-16 sm:mt-20">
                  <h3 class="m-0 text-lg font-medium tracking-[-0.03em]">
                    {{ principle.title }}
                  </h3>
    ...
    >
      <div data-reveal>
        ...
        <p class="mt-4 text-xs text-muted">404 / Proyecto no disponible</p>
        <h1
...
const sourceUrl = computed(() =>
  project.value?.is_public && project.value.repository?.visibility === "public"
...
const dateRange = (item: PortfolioProject) =>
  [dateLabel(item.started_at || item.created_at), dateLabel(item.completed_at)]
    .filter(Boolean)
